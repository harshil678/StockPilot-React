...
export const WITHDRAWAL_PROCEED_REQUEEST = "WITHDRAWAL_PROCEED_REQUEEST";
...
export const ADD_PAYMENT_DETAILS_REQUEST = "ADD_PAYMENT_DETAILS_REUQEST";
...
export const GET_ALL_WITHDRAWAL_FAILURE = "GET_ALL_WITHDRAWAL_FAILURE";
